...
import java.util.*;
     ...
     class OddsAndEvens implements Runnable{
         public void run(){
            ...
            System.out.println("Hi " + name + ", which do you choose? choose: 'O' for odds or 'E' for evens? ");
...
public class GameDemo {
    public static void main(String[] args) {
        ...
        Thread thread = new Thread(oddsAndEvens);
        thread.start();
    }
}
